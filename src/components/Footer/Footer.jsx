  ...
  return (
    <footer className=" sm:footer-horizontal flex flex-col md:flex-row gap-5 md:gap-10 bg-gray-900 text-base-content p-10">
      <div className='flex-1 max-w-[500px]'>
        ...
        <p className='text-white'>MyApp is designed to make your life easier. Organize tasks, set reminders, track progress, and boost productivity. With a simple interface and reliable performance, MyApp helps you achieve more every day, anywhere, anytime.</p>
      </div>
